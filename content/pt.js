export const pt = {
  ...
  nav: {
    ...
    engineer: 'O que fazemos',
    work: 'Trabalhos',
    products: 'Produtos & Plataformas',
    aes: 'AES',
    engage: 'Modelos',
    faq: 'Perguntas',
    cta: 'Iniciar projeto',
  ...
  hero: {
    ...
    titleLine1: 'Não vendemos desenvolvedores.',
    titleLine2: 'Engenharamos',
    titleMuted: 'produtos.',
    sub: 'A AlexDev projeta produtos digitais modernos por meio de um sistema onde a IA é parte do método de engenharia — e os engenheiros humanos tomam cada decisão final.',
    ...
    spec: {
      ...
      status: 'Ativo',
      rows: [
        { n: '01', l: 'Descoberta', tag: 'Liderado por humanos' },
        { n: '02', l: 'Arquitetura', tag: 'Liderado por humanos' },
        { n: '03', l: 'Desenvolvimento AI-Native', tag: 'IA + humano' },
        { n: '04', l: 'Revisão humana', tag: 'Humano decide', gate: true },
        { n: '05', l: 'QA e segurança', tag: 'IA + humano' },
        { n: '06', l: 'Implantação', tag: 'Automatizada' },
        { n: '07', l: 'Evolução', tag: 'Contínua' },
      ],
    },
  },
  ...
  trust: {
    ...
    metrics: [
      ...
      { v: '10k+', k: 'Famílias integradas em um sistema', src: 'Swap Kids' },
    ],
    stackLabel: 'Engenharado com',
  ...
  framework: {
    ...
    lead: 'Quatro princípios regem cada produto que construímos.',
    cards: [
      { n: 'P01', h: 'Arquitetura antes do código', p: 'Projetamos o sistema antes de escrever uma única linha.' },
      { n: 'P02', h: 'IA por design', p: 'A IA está integrada em todo o fluxo.' },
      { n: 'P03', h: 'Responsabilidade humana', p: 'Cada resultado passa por revisão humana.' },
      { n: 'P04', h: 'Sistemas antes de recursos', p: 'Construímos produtos que suportam o crescimento.' },
    ],
  },

  engineer: {
    id: 'O que fazemos',
    h2: 'Duas linhas, um único padrão de engenharia',
    lead: 'De uma landing de $99 a uma plataforma de IA empresarial.',
    laneEng: {
      title: 'Projetos de engenharia',
      kind: 'Por escopo',
      rows: [
        { li: 'Sistemas de IA', ld: 'agentes · RAG · automação' },
        { li: 'Plataformas FinTech', ld: 'pagamentos · empréstimos · carteiras' },
        { li: 'Plataformas SaaS', ld: 'multi-tenant · faturamento' },
        { li: 'Gaming e GameFi', ld: 'tempo real · economias tokenizadas' },
        { li: 'Produtos Web3', ld: 'emissão de tokens e NFT · contratos · auditorias' },
        { li: 'Plataformas de negócios', ld: 'portais · CRM · ERP' },
        { li: 'Automação', ld: 'pipelines de ponta a ponta' },
      ],
    },
    laneQuick: {
      ...
      rows: [
        ...
        { li: 'Bots do Telegram', ld: 'a partir de $500' },
  ...
  work: {
    ...
    lead: 'Produtos reais com métricas reais.',
    projects: [
      {
        dm: 'FinTech · AI', yr: '2025', name: 'MEM Cash', url: 'memcash.app', href: 'https://memcash.app',
        desc: 'Plataforma de microcrédito com IA agêntica.',
      ...
      },
      {
        ...
        desc: 'Grupos de poupança rotativa (ROSCA) e empréstimos P2P em contratos inteligentes.',
    ...
    items: [
      {
        ...
        desc: 'Uma plataforma de IA que transforma o conhecimento, catálogo, regras e processos da empresa em um sistema de IA para solicitações de clientes e vendas.',
        industries: ['Móveis', 'Automotivo', 'Imobiliário', 'Varejo', 'Serviços'],
        primaryCta: 'Explorar Showroom AI',
        primaryHref: 'https://showroom-ai.pro/',
        secondaryCta: 'Saiba mais',
        secondaryHref: '/pt/showroom-ai',
        metrics: [
          { mv: '5 min', mk: 'Velocidade da proposta' },
          { mv: '98.7%', mk: 'Precisão' },
          { mv: 'Multi-tenant', mk: 'Arquitetura' }
        ],
      },
      {
        ...
        tagline: 'Assistente de IA para WhatsApp',
        desc: "Assistente de IA para WhatsApp que opera com a base de conhecimento da sua empresa, qualifica leads e automatiza o atendimento 24/7.",
        features: ['WhatsApp Cloud API', 'Motor de Conhecimento', 'Integração CRM'],
        primaryCta: 'Explorar AI Business Assistant',
        primaryHref: '/pt/ai-business-assistant',
        metrics: [
          { mv: 'WhatsApp', mk: 'Cloud API v23.0' },
          { mv: '24/7', mk: 'Assistente de IA' },
          { mv: 'Bitrix24', mk: 'Integração CRM' }
        ],
      },
    ],
  },
