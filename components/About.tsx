...
const PILLARS = [
  {
    ...
    text: "Александр лично проектирует архитектуру и пишет ключевой код каждого проекта — с 2014 года в разработке.",
  },
  {
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-gray-400 text-lg leading-relaxed">
              <p>
                ...
                <span className="text-white font-semibold">Александр</span> — Founder &amp; Lead
              ...
              <p>
                ...
                Александр собирает команду из проверенной сети{" "}
