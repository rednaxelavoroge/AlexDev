...
const dict: Dict = {
  ...
  contact: {
    ...
    fieldName: "Ваше имя",
    fieldContact: "Как с вами связаться (WhatsApp / Telegram / email)",
    fieldType: "Тип проекта",
    fieldMessage: "Описание задачи",
    placeholderName: "Иван Иванов",
    placeholderContact: "+995 …, @username или email",
    ...
    successText:
      "Спасибо! Свяжемся с вами в течение 24 часов. Для срочных вопросов — WhatsApp, Telegram или email.",
