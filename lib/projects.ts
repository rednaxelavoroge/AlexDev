...
export const PROJECTS: Project[] = [
  ...
  },
  {
    slug: "nexuswallet",
    title: "NexusWallet",
    tagline: "Multi-chain crypto wallet with DeFi dashboard",
    category: "Web3",
    year: "2025",
    description:
      "Non-custodial multi-chain crypto wallet with built-in DEX aggregator, portfolio tracker and one-tap staking across 12+ DeFi protocols. Full DeFi command center in your pocket.",
    fullDescription:
      "Self-custody wallet supporting Ethereum, Solana, Polygon and 10+ EVM chains. Features include: built-in DEX aggregator with best-route swapping, real-time portfolio dashboard with P&L tracking, one-tap staking and yield farming, NFT gallery, and hardware wallet (Ledger/Trezor) integration. All private keys stay on device — never leave the client.",
    challenge:
      "Users juggle 3–4 apps to swap, stake and track crypto — losing money to bad routes and missed yield opportunities.",
    solution:
      "Built a unified non-custodial wallet with DEX aggregation across 1inch, Uniswap and Jupiter, plus a staking aggregator that auto-selects the highest APY across protocols.",
    outcome:
      "12,000+ active wallets created in the first quarter with $4.8M total value tracked and average user saving 22% on swap fees via aggregation.",
    technologies: ["React Native", "TypeScript", "Web3.js", "Hardhat", "PostgreSQL"],
    metrics: [
      { label: "Active wallets", value: "12,000+" },
      { label: "Total value tracked", value: "$4.8M" },
      { label: "Swap fee saved", value: "22%" },
    ],
    status: "live",
    device: "browser",
    shot: null,
