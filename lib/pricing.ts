...
export const PRICING_TIERS: PricingTier[] = [
  ...
  },
  {
    ...
    priceUsd: 299,
    unit: "from",
    taglineEn: "Organic traffic growth from Google",
    taglineRu: "Рост органического трафика из Google",
    features: [
      "Technical SEO audit",
  ...
  },
  {
    ...
    priceUsd: 499,
    unit: "from",
    taglineEn: "Content, social media and paid ads",
    taglineRu: "Контент, соцсети и платная реклама",
    features: [
      "Social media strategy and content",
      "Email marketing campaigns",
      "Paid ads (Google / Meta)",
      "Funnel and conversion optimization",
      "Brand copywriting and visuals",
  ...
  },
  {
    ...
    priceUsd: 299,
    unit: "from",
    taglineEn: "Get found in ChatGPT, Perplexity, Claude & Gemini",
    taglineRu: "Появляйтесь в ChatGPT, Perplexity, Claude и Gemini",
    features: [
