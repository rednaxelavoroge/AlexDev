...
const PROJECT_LIST: Project[] = [
  ...
  {
    id: 1,
    title: 'Showroom AI (Monte Salotti Assistant)',
    category: 'ИИ & Боты',
    description: 'Интеллектуальный ИИ-ассистент для мебельных шоурумов. Парсит чаты клиентов, считает цены и генерирует спецификации.',
    fullDescription: 'Инновационная SaaS-платформа на базе AI, разработанная для итальянского мебельного бренда Monte Salotti. Система автоматически обрабатывает входящие неструктурированные сообщения от клиентов (текст, голосовые, фото), извлекает параметры мебели (размеры, ткань, ножки) и генерирует готовые коммерческие предложения, счета и заказы на фабрику.',
    image: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?auto=format&fit=crop&w=800&q=80',
    technologies: ['Next.js', 'OpenAI GPT-4o', 'PostgreSQL', 'TailwindCSS', 'TypeScript'],
    link: 'https://montesalotti-assistant.vercel.app/',
    isNda: false,
    metrics: [
  ...
  },
  {
    ...
    description: 'Децентрализованная блокчейн-платформа для совместного накопления и взаимного кредитования по принципу ROSCA.',
    fullDescription: 'Decentralized Finance (DeFi) Web-приложение, реализующее классическую модель финансовых кругов (ROSCA) на смарт-контрактах. Участники объединяют средства в пулы, по очереди получают всю сумму досрочно с дисконтом, а терпеливые участники зарабатывают процентный доход.',
  ...
  },
  {
    ...
    category: 'ИИ & Боты',
    description: 'Закрытая шеринг-экосистема в Telegram для бесплатного обмена детскими вещами с веб-витриной.',
    fullDescription: 'Автоматизированная экосистема обмена вещами (своп), состоящая из сложного Telegram-бота и интерактивной Web-витрины. Родители могут отдавать ненужные детские вещи, получать за это баллы и обменивать их на необходимые товары в закрытом сообществе.',
  ...
  {
    id: 4,
    title: 'Webtransfer — P2P Social Lending Network',
    category: 'Web3 & Крипто',
    description: 'Социальная сеть кредитования на блокчейне. Децентрализованные займы напрямую между пользователями.',
    fullDescription: 'Высоконагруженная социальная P2P-кредитная сеть, интегрирующая традиционные соцсети с блокчейн-кошельком. Позволяет выдавать и получать микрозаймы напрямую у других участников без засредников и банковских комиссий.',
  ...
  {
    id: 5,
    title: 'QADSAN — Token-Shares Trading Simulation',
    category: 'Web3 & Крипто',
    description: 'Игровая финансовая платформа, симулирующая биржевую торговлю токенизированными акциями.',
    fullDescription: 'Многопользовательская Web3-игра и трейдинг-симулятор. Игроки могут покупать, продавать и стейкать виртуальные токенизированные доли-акции, реагирующие на новостной фон и действия других участников.',
  ...
  {
    id: 6,
    title: 'Ijareteli — Premium Art Gallery Showcase',
    category: 'SaaS & Web-системы',
    description: 'Элитное цифровое портфолио и виртуальный зал для грузинского художника Фридона Болквадзе.',
    fullDescription: 'Премиальный концептуальный сайт-портфолио грузинского живописца и дизайнера Фридона Болквадзе (Ijareteli). Демонстрирует каталог из 2000+ оцифрованных картин с плавной интерактивной анимацией и виртуальной экспозицией.',
